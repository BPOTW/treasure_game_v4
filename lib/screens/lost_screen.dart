...
class GameLostScreen extends StatelessWidget {
  ...
  const GameLostScreen({super.key, required this.onContinue});
        ...
        children: [
          ...
          ParchmentContainer(
            child: Column(
              children: [
                 Text(
                    "Nice try, genius. The riddle outsmarted you today. You gave it a shot, but the prize isn’t for everyone. Still, thanks for playing!",
